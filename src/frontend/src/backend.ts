...
import type { ExternalBlob as _ExternalBlob, Perfume as _Perfume, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPerfume(arg0: string, arg1: string, arg2: string, arg3: Array<string>, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPerfume(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addSocialLink(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deletePerfume(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deletePerfume(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteSocialLink(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllSocialLinks(): Promise<Array<SocialLink>> {
        if (this.processError) {
            try {
    ...
    async getPerfume(arg0: string): Promise<Perfume> {
        if (this.processError) {
            try {
                const result = await this.actor.getPerfume(arg0);
                return from_candid_Perfume_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updatePerfume(arg0: string, arg1: string, arg2: string, arg3: Array<string>, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePerfume(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSocialLink(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_Perfume_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Perfume): Promise<Perfume> {
...
async function from_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        fragranceNotes: value.fragranceNotes,
        name: value.name,
...
async function from_candid_vec_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Perfume>): Promise<Array<Perfume>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Perfume_n10(_uploadFile, _downloadFile, x)));
}
